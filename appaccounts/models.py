...
class Profile(models.Model):
    ...
    def get_absolute_url(self):
        return reverse('appaccounts:profile', args=[str(self.id)])
    ...
    def get_avatar_url(self):
        if self.avatar:
            ...
            return settings.STATIC_URL + 'images/people/user_black.svg'

    def get_avatar_white_url(self):
        if self.avatar:
            return self.avatar.url
        else:
            return settings.STATIC_URL + 'images/people/student_white.svg'
